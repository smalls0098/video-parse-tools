...
namespace smalls\videoParseTools\enums;
...
class UserAgentType
{
     ...
     * windows下面的浏览器
     */
    const PC_USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36";
